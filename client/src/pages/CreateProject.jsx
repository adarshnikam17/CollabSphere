        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-8">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                type="text"
                placeholder="e.g. AI Chatbot Web App"
                value={form.title}
            ...
            <div>
              <label className="text-sm text-gray-400 mb-1 block">Skills Required <span className="text-violet-400">(Press Enter)</span></label>
              <input
                type="text"
            ...
            <div>
              <label className="text-sm text-gray-400 mb-1 block">Tech Stack <span className="text-violet-400">(Press Enter)</span></label>
              <input
                type="text"
                placeholder="MERN, Docker, AWS..."
                value={techInput}
